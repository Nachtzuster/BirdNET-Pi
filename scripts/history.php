...
$statement1 = get_detection_count_by_date($theDate);
ensure_db_ok($statement1['success']);
$totalcount = $statement1['data'];
...
if(isset($_GET['blocation']) ) {
	...
	for($i=0;$i<$hrsinday;$i++) {
		...
		$statement1 = get_detection_breakdown_by_time($theDate,$starttime,$endtime);
		ensure_db_ok($statement1['success']);
